...
export default function Hero() {
  return (
    <section className="flex flex-col items-center pt-0 text-center">
      ...
      <p className="mt-1 max-w-full whitespace-nowrap font-display text-base font-medium text-ink-soft">
